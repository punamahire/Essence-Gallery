        ...
        <>
            ...
            <div className="container photo-container">
                {columns === 3 ?
                    <Row>
                        {photosInGallery.map(photo => {
                            return (<div className="col-sm-4 pb-3" key={photo.id}>
                                <img style={{ width: 300, height: 200 }} className="card-img" src={photo.imageUrl} alt="3 column grid"></img>
                            </div>)
                        })
                        }
                    </Row>
                    ...
                    <div className="row">
                        {photosInGallery.map(photo => {
                            return (<div className="col-sm-3 pb-3" key={photo.id}>
                                <img style={{ width: 300, height: 200 }} className="card-img" src={photo.imageUrl} alt='4 column grid' />
                            </div>)
                        })
                        }
                    </div>
